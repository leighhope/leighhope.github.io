...
var _cardFooterStyle = require("../../assets/jss/material-kit-react/components/cardFooterStyle");
...
function CardFooter(_ref) {
  ...
  var cardFooterClasses = (0, _classnames2.default)((_classNames = {}, _defineProperty(_classNames, classes.cardFooter, true), _defineProperty(_classNames, className, className !== undefined), _classNames));
